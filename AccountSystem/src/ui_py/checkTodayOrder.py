...
class Ui_TodayRecord(object):
    def setupUi(self, TodayRecord):
        ...
        self.scrollArea.setGeometry(QtCore.QRect(50, 200, 500, 450))
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(50, 160, 501, 41))
        ...
        self.totalPrice_label.setGeometry(QtCore.QRect(400, 650, 150, 50))
        font = QtGui.QFont()
        font.setFamily("微軟正黑體")
        font.setPointSize(12)
